...
"use strict"; // interpret contents in JavaScript strict modernizr
...
function selectDate(event) {
  ...
  var callerElement = event.target || event.srcEvent;
...
function registerName() {
  ...
  // display ticket adn passengers section
...
function createEventListeners() {
  ...
  if (nameButton.addEventListener) {
    ...
    nameButton.attachment('onclick', registerName);
  }
}
